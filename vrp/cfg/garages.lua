...
--  },
 ...
 ----------   
  ...
  ["Vehicle Garage"] = {
	...
	["bmx"] = {"BMX",300, ""},
	["cruiser"] = {"Cruiser",400, ""},
	["Scorcher"] = {"Scorcher",425, ""},
	["fixter"] = {"Fixter",425, ""},
	["tribike2"] = {"Tribike2", 2000, ""},
	["tribike3"] = {"Tribike3",2000, ""},
    ["AKUMA"] = {"Akuma",6200, ""},
    ["bagger"] = {"Bagger",19000, ""},
    ["bati"] = {"Bati 801",15000, ""},
    ["bati2"] = {"Bati 801RR",65000, ""},
    ["bf400"] = {"BF400",6000, ""},
	["lectro"] = {"Lectro",20000, ""},
    ["carbonrs"] = {"Carbon RS",16000, ""},
    ["cliffhanger"] = {"Cliffhanger",35000, ""},
    ["double"] = {"Double T",12000, ""},
    ["enduro"] = {"Enduro",8000, ""},
    ["faggio2"] = {"Faggio",2000, ""},
    ["gargoyle"] = {"Gargoyle",60000, ""},
    ["hakuchou"] = {"Hakuchou",11000, ""},
	["daemon"] = {"Harley Knucklehead",20000, ""},
    ["hexer"] = {"Hexer",80000, ""},
    ["innovation"] = {"Innovation",74560, ""},
    ["nemesis"] = {"Nemesis",10000, ""},
    ["pcj"] = {"PCJ-600",5000, ""},
    ["ruffian"] = {"Ruffian",10000, ""},
    ["sanchez"] = {"Sanchez",3000, ""},
    ["sovereign"] = {"Sovereign",16000, ""}, -- looking for replacement
    ["thrust"] = {"Thrust",15000, ""},
    ["vader"] = {"Vader",5000, ""},
    ["vindicator"] = {"Vindicator",12000,""},
	["bison"] = {"Bison",26000, ""},
    ["blade"] = {"Blade",24000, ""},
    ["bobcatxl"] = {"Bobcat XL",13000, ""},
    ["buccaneer"] = {"Buccaneer",30000, ""},
    ["cavalcade"] = {"Cavalcade",63000, ""},
    ["Chino"] = {"Chino",8000, ""},
    ["cognoscenti"] = {"Cognoscenti",200000, ""},
    ["dukes"] = {"Dukes",35000, ""},
    ["faction"] = {"Faction",8000, ""},
    ["felon"] = {"Felon", 102000, ""},
    ["felon2"] = {"Felon GT", 130000, ""},
    ["fugitive"] = {"Fugitive",45000, ""},
    --["hotknife"] = {"Hotknife",199999, ""},
    ["jackal"] = {"Jackal", 50000, ""},
    ["landstalker"] = {"Landstalker",47000, ""},
    ["minivan"] = {"Minivan",20000, ""},
    --["omnis"] = {"Omnis",89500, ""},
    ["oracle"] = {"Oracle", 74000, ""},
    ["oracle2"] = {"Oracle XS",79000, ""},
    --["paradise"] = {"Paradise",17000, ""},
    ["radi"] = {"Radius",28000, ""},
    ["seminole"] = {"Seminole",28000, ""},
    ["stretch"] = {"Stretch",95000, ""},
    ["sultan"] = {"Sultan",30000, ""},
    --["surfer"] = {"Surfer",40000, ""},
    ["tailgater"] = {"Tailgater",57000, ""},
    ["windsor2"] = {"Windsor Drop",370000, ""},
    ["youga"] = {"Youga",20000, ""},
    ["zion"] = {"Zion", 44000, ""},
    ["zion2"] = {"Zion Cabrio", 46000, ""},
	--["brawler"] = {"Brawler",60000, ""},
    ["dubsta3"] = {"Dubsta 6x6",975000, ""},
    ["rebel2"] = {"Rebel",18000, ""},
	--["fordh"] = {"Ford H",500000, ""},
    ["sandking"] = {"Sandking XL",43000, ""},
	--["sandkinghd"] = {"Sandking Monster Truck",550000, ""},
    --["trophytruck"] = {"The Liberator",75000, ""},
	--["monster"] = {"The Liberator Monster",350000, ""},
    --["bifta"] = {"Bifta",10000, ""}, -- atvs start here
    ...
    --["dune"] = {"Dune Buggy",8000, ""},
	["asea"] = {"Asea",14000, ""},
    ["asterope"] = {"Asterope",23000, ""},
    ["blista"] = {"Blista", 30000, ""},
    ["brioso"] = {"Brioso R/A", 25000, ""},
    ["dilettante"] = {"Dilettante", 22000, ""},
    ["glendale"] = {"Glendale",10000, ""},
    --["journey"] = {"Journey",5000, ""},
    ["ingot"] = {"Ingot",1000, ""},
    ["issi2"] = {"Issi", 25000, ""},
    ["intruder"] = {"Intruder",58000, ""},
    ["panto"] = {"Panto", 13000, ""},
    ["penumbra"] = {"Penumbra", 20000, ""},
    ["picador"] = {"Picador",18000, ""},
    ["prairie"] = {"Prairie", 17000, ""}, -- stop
    ["premier"] = {"Premier",14990, ""},
    ["primo"] = {"Primo",9000, ""},
    ["primo2"] = {"Primo Custom",9500, ""},
    ["regina"] = {"Regina",11000, ""},
    ["rhapsody"] = {"Rhapsody", 8200, ""},
    ["rumpo"] = {"Rumpo",30900, ""},
    ["stanier"] = {"Stanier",14000, ""},
    ["stratum"] = {"Stratum",19000, ""},
    ["surge"] = {"Tesla S P90D",33000, ""},
    ["washington"] = {"Washington",47000, ""},
    ["windsor"] = {"Windsor",302000, ""},
	["casco"] = {"Casco",7392000, ""},
	["c10custom"] = {"C10 Custom",500000, ""},
    ["coquette2"] = {"Coquette Classic",109000, ""},
    ["jb700"] = {"JB 700",55000, ""},
    ["pigalle"] = {"Pigalle",126000, ""},
	--["firebird"] = {"Pontiac Firebird 1970",350000, ""},
    ["stinger"] = {"Stinger",19250000, ""},
    ["stingergt"] = {"Stinger GT",38750000, ""},
    ["feltzer3"] = {"Stirling",106700, ""},
    ["ztype"] = {"Z-Type",4408000,""},
	["adder"] = {"Adder",1300000, ""},
    ["r8ppi"] = {"Audi R8",1700000, ""},
    ["bullet"] = {"Bullet",155000, ""},
    ["cheetah"] = {"Cheetah",650000, ""},
    ["entityxf"] = {"Entity XF",545000, ""},
    ["fmj"] = {"FMJ",375000, ""},
    ["infernus"] = {"Infernus",220000, ""},
    ["lynx"] = {"Lynx",135000, ""},
    ["massacro"] = {"Massacro",280000, ""},
    ["massacro2"] = {"Massacro (Racecar)",585000, ""},
    ["osiris"] = {"Osiris",1400000, ""},
    --["reaper"] = {"Reaper",1595000, ""},
    ["le7b"] = {"RE-7B",2075000, ""},
    ["sheava"] = {"ETR1",1909500, ""},
    ["schafter3"] = {"Schafter V12",59000, ""},
    --["ySbrImpS11"] = {"Subaru Impreza",200000, ""},
    ["sultanrs"] = {"Sultan RS",180000, ""},
    ["t20"] = {"T20",1150000,""},
    ["tropos"] = {"Tropos",650000, ""},
    ["turismor"] = {"Turismo R",1200000, ""},
    ["tyrus"] = {"Tyrus",13000000, ""},
    ["vacca"] = {"Vacca",340000, ""},
    ["voltic"] = {"Voltic",250000, ""},
    ["prototipo"] = {"X80 Proto",27000000, ""},
    ["zentorno"] = {"Zentorno",9205000,""},
	--["rs6"] = {"Audi RS6",70000, ""},
    ["sentinel"] = {"Sentinel", 40000, ""},
    ["baller"] = {"Baller",77000, ""},
    ["bestiagts"] = {"Bestia GTS",600000, ""},
    ["blista"] = {"Blista Compact",20000, ""},
    ["buffalo"] = {"Buffalo",35000, ""},
    ["buffalo2"] = {"Buffalo S",56000, ""},
    ["dominator"] = {"Dominator",44000, ""},
    ["exemplar"] = {"Exemplar", 305000, ""},
    ["fusilade"] = {"Fusilade",36000, ""},
    ["gburrito"] = {"Gang Burrito",165000, ""},
    ["gauntlet"] = {"Gauntlet",47000, ""},
    ["granger"] = {"Grabger",40000, ""},
    ["huntley"] = {"Huntley",85000, ""},
	["kuruma"] = {"Kuruma",64000, ""},
    --["nightshade"] = {"Nightshade",72000, ""},
    ["rapidgt"] = {"Rapid GT",130000, ""},
    ["rapidgt2"] = {"Rapid GT Convertible",150000, ""},
    ["rocoto"] = {"Rocoto",61000, ""},
    ["sabregt"] = {"Sabre Turbo",72000, ""},
    ["schafter2"] = {"Schafter",51000, ""},
    ["sentinel2"] = {"Sentinel XS", 48000, ""},
	["elegy"] = {"Elegy",109000, ""},
    ["superd"] = {"Super Diamond",500000, ""},
    --["tampa"] = {"Tampa",72000, ""},
    ["verlierer2"] = {"Verkierer",89500,""},
    ["vigero"] = {"Vigero",72000, ""},
    ["virgo"] = {"Virgo",15000, ""},
    --["warrener"] = {"Warrener",75000, ""},
    ["xls"] = {"XLS",85000, ""},
	["ninef"] = {"9F",190000, ""},
    ["ninef2"] = {"9F Cabrio",220000, ""},
    ["alpha"] = {"Alpha",98000, ""},
    ["banshee"] = {"Banshee",105000, ""},
    ["banshee2"] = {"Banshee 900R",120000, ""},
    ["carbonizzare"] = {"Carbonizzare",410000, ""},
	--["chantom"] = {"Chantom Semi",110000, ""},
    --["cognoscenti2"] = {"Cognoscenti(Armored)",80000, ""},
    ["cogcabrio"] = {"Cognoscenti Cabrio",256000, ""},
    ["comet2"] = {"Comet",92000, ""},
    ["coquette"] = {"Coquette",138000, ""},
    ["coquette3"] = {"Coquette BlackFin",150000, ""},
    ["tampa2"] = {"Drift Tampa",95000, ""},
    ["feltzer2"] = {"Feltzer",130000, ""},
    ["furoregt"] = {"Furore GT",108000, ""},
	["gtr"] = {"GTR Nismo",90000, ""},
  ...
  ["Pilotsa"] = {
    _config = {vtype="plane",blipid=16,blipcolor=30,permissions={"pilot.vehicle"}},
     ["mammatus"] = {"Mammatus",0, "jet"},
	 ["cuban800"] = {"Cuban 800",0,"jet"}
  },
    ["airP"] = {
  ...
  ["delivery"] = {
    ...
    ["burrito3"] = {"Mercedes Sprinter 311 CDI",0, "GLS"},
	["Speedo"] = {"Mercedes Sprinter 2013",0, "Food Delivery"},
	["taco"] = {"Taco Food Truck",0, "Food Delivery"}
  },
  ["repair"] = {
   ...
   ["miner"] = {
    _config = {vtype="car",blipid=50,blipcolor=31,permissions={"miner.vehicle"}},
    ["tiptruck"] = {"tiptruck",0, "tiptruck"}
  },
  ["bankdriver"] = {
...
cfg.garages = {
  ...
  {"bankdriver",-5.5064234733582,-669.79876708984,32.338081359863},   -- jobs garage
  {"Vehicle Garage",-288.99221801758,-992.91589355469,24.137050628662},  -- house garage
  {"Vehicle Garage",-332.93212890625,-780.44891357422,33.964714050293},  -- house garage
  {"Vehicle Garage",236.31634521484,-778.17608642578,30.689039230347},  -- house garage
  {"Vehicle Garage",-741.96795654297,-70.143226623535,41.750022888184},  -- house garage
  {"Vehicle Garage",-1216.0319824219,-667.76123046875,25.522775650024},  -- house garage
  {"Vehicle Garage",-208.56956481934,284.61038208008,92.757934570313},  -- house garage
  {"Vehicle Garage",1512.7855224609,3755.0690917969,34.012046813965},  -- house garage
  {"Vehicle Garage",127.52474212646,6605.5043945313,31.416763305664}, -- paleto garage
  {"Vehicle Garage",48.23136138916,-730.02056884766,44.312480926514}, -- additional garage
  {"Vehicle Garage",1703.9978027344,4802.9008789063,41.334579467773}, -- grape seed garage
  {"Vehicle Garage",-81.833595275879,-808.06616210938,36.104591369629}, -- maze bank garage
  {"Vehicle Garage",-800.40301513672,332.49713134766,85.700492858887},
  {"Vehicle Garage",-516.030,-294.104,35.223},
 ...
 -- {"House Garage",684.44097900391,-719.58734130859,25.884830474854},
  ...
  {"miner",2687.0463867188,2764.6782226563,37.877990722656}
