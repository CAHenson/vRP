...
--  },
  ...
  ["Miner"] = {
    _config = { gtype = "job",
	onspawn = function(player) vRPclient.notify(player,{"You are a Miner."}) end
    },
	"mission.coal.miner",
	"mission.copper.miner",
	"mission.iron.miner",
	"mission.silver.miner",
	"mission.gold.miner",
	"mission.diamond.miner",
	"miner.service",
	"miner.vehicle",
	"uber.service"
	},
  ...
  ["EMS"] = {
    _config = { gtype = "job",
	onspawn = function(player) vRPclient.notify(player,{"You are a medic."}) end
	},
    "emergency.revive",
	"police.pc",
    --"police.wanted",
  ...
  ["Tyrone Towers"] = {
    _config = { gtype = "job",
	onspawn = function(player) vRPclient.notify(player,{"You work for Tyrone Towers."}) end
	},
    "vehicle.repair",
    "vehicle.replace",
    "repair.service",
  ...
  ["SG Mechanic"] = {
    _config = { gtype = "job",
	onspawn = function(player) vRPclient.notify(player,{"You work for SG Mechanics."}) end
	},
    "vehicle.repair",
    "vehicle.replace",
    "repair.service",
  ...
  ["Pilot"] = {
    _config = { gtype = "job",
	onspawn = function(player) vRPclient.notify(player,{"You are a Pilot for the state."}) end
	},
    "mission.pilot.cargo",
	"pilot.service",
	"pilot.vehicle",
...
--},
  ["Unemployed"] = {
    _config = { gtype = "job",
	onspawn = function(player) vRPclient.notify(player,{"You are Unemployed! Get a job!"}) end
	},
	"uber.service",
	"citizen.paycheck"
  },
  ["Delivery"] = {
    _config = { gtype = "job",
	onspawn = function(player) vRPclient.notify(player,{"You are Delivery Driver."}) end
	},
...
cfg.selectors = {
  ["Job Selector"] = {
    _config = {x = -515.41760253906, y = -234.77946472168, z = 35.84428024292, blipid = 351, blipcolor = 47},
    "Mechanic",
	"Delivery",
	"Bankdriver",
	"Fisher",
  ...
  ["Miner"] = {
    _config = {x = 2569.5983886719, y = 2720.0327148438, z = 42.930316925049, blipid = 472, blipcolor = 4},
    "Miner",
    "Unemployed"
  }
